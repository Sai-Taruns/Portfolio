      ...
      <div className="flex justify-between items-center mt-8 lg:mt-16 flex-col lg:flex-row">
                ...
                {[BiLogoGmail, IoLogoLinkedin, IoLogoTwitter, BsGithub].map(
                  (Icon, index) => (
                    <motion.a
                      ...
                      href={
                        index === 0
                          ? "mailto:saitaruns098@gmail.com"
                          : index === 1
                          ? "https://www.linkedin.com/in/taruns42"
                          : index === 2
                          ? "#"
                          : "https://github.com/"
                      }
        ...
        >
          ...
          <p className="text-[#71717A] text-sm/6 lg:text-base mt-3 lg:mt-6">
            I specialize in designing scalable data pipelines, cloud-native platforms,
  and AI/ML-ready architectures across AWS, Azure, and GCP. Open to full-time
  roles, long-term contracts, and impactful data engineering or machine learning
  projects.
          </p>
          ...
          <div className="font-semibold text-sm lg:text-xl flex flex-col mt-6 gap-2 lg:gap-4">
            <motion.a
              ...
              href="mailto:saitarun.s42@gmail.com"
            >
              <span className="border-2 transition-all border-transparent group-hover:border-black rounded-full p-1">
                <IoMdMail className="w-4 h-4 lg:w-5 lg:h-5" />
              </span>
              saitarun.s42@gmail.com
            </motion.a>

            <motion.a
              whileHover={{ x: 5 }}
              className="flex items-center gap-2 group"
              href="tel:+17136599389"
            >
